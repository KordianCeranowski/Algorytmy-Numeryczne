...
public class Ln {
    ...
    public double getSum(ArrayList<Double> values, int lastIndex){
        double sum = 0;
    ...
    public double getReverseCountedSum(ArrayList<Double> values, int lastIndex){
        double sum = 0;
